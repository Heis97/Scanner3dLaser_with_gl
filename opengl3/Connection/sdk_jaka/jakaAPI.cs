...
namespace jakaApi
{
	...
	public class jakaAPI
	{
		...
		[DllImport("jakaAPI.dll", EntryPoint = "circular_move_extend", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int circular_move_extend_mode(ref int i, ref JKTYPE.CartesianPose end_pos, ref JKTYPE.CartesianPose mid_pos, JKTYPE.MoveMode move_mode, bool is_block, double speed, double acc, double tol, ref JKTYPE.OptionalCond option_cond, int circle_cnt, int circle_mode);
		...
		[DllImport("jakaAPI.dll", EntryPoint = "set_torque_sensor_comm", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int set_torque_sensor_comm(ref int i, int type, [MarshalAs(UnmanagedType.LPStr)] string ip_addr, int port);

		[DllImport("jakaAPI.dll", EntryPoint = "get_torque_sensor_comm", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int get_torque_sensor_comm(ref int i, ref int type, [MarshalAs(UnmanagedType.LPStr)] StringBuilder ip_addr, ref int port);
