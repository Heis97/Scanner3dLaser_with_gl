...
vec3 interpolate(vec3 p1, vec3 p2, float val1, float val2) {
    return (p1 + p2) * 0.5;
    /*if (abs(val1 - val2) < 0.00001) return (p1 + p2) * 0.5;
...
void main() {
    ...
    /*vertList[0] = vec3(1.1,2.1,3.1);
    vertList[1] = vec3(1.11,2.11,3.11); 
    vertList[2] = vec3(1.12,2.12,3.12);
    vertList[3] = vec3(1.13,2.13,3.13);
    vertList[4] = vec3(1.14,2.14,3.14);
    vertList[5] = vec3(1.15,2.15,3.15); 
    vertList[6] = vec3(1.16,2.16,3.16); 
    vertList[7] = vec3(1.17,2.17,3.17);
    vertList[8] = vec3(1.18,2.18,3.18);
    vertList[9] = vec3(1.19,2.19,3.19);
    vertList[10] = vec3(1.111,2.111,3.111);
    vertList[11] = vec3(1.112,2.112,3.112);*/
    ...
    if (pass == 0) {
        ...
        setVoxel_debug(x,y,z,numTriangles);
    } 
    else {
        ...
        for (int tri = 0; tri < numTriangles; tri++) {
            ...
            //if (i0 < 0 || i0 >= 12 || i1 < 0 || i1 >= 12 || i2 < 0 || i2 >= 12)  continue;
